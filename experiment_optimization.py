...
if __name__ == "__main__":
    # Real Topologies
    run_experiment("ChinaNet", "chinanet.csv", 100)
    print("ChinaNet", flush=True)
    run_experiment("Geant", "geant.csv", 100)
    print("Geant", flush=True)
    run_experiment("Internet2", "internet2.csv", 100)
    print("Internet2", flush=True)
    run_experiment("RNP", "rnp.csv", 100)
    print("RNP", flush=True)

    # Random Graphs with varied connectivity
    run_experiment("Random_80_0.1", "random_80_01.csv", 100)
    print("Random 80 0.1", flush=True)
    run_experiment("Random_80_0.2", "random_80_02.csv", 100)
    print("Random 80 0.2", flush=True)
    run_experiment("Random_80_0.3", "random_80_03.csv", 100)
    print("Random 80 0.3", flush=True)
    run_experiment("Random_100_0.1", "random_100_01.csv", 100)
    print("Random 100 0.1", flush=True)
    run_experiment("Random_100_0.2", "random_100_02.csv", 100)
    print("Random 100 0.2", flush=True)
    run_experiment("Random_100_0.3", "random_100_03.csv", 100)
    print("Random 100 0.3", flush=True)
    run_experiment("Random_120_0.1", "random_120_01.csv", 100)
    print("Random 120 0.1", flush=True)
    run_experiment("Random_120_0.2", "random_120_02.csv", 100)
    print("Random 120 0.2", flush=True)
    run_experiment("Random_120_0.3", "random_120_03.csv", 100)
    print("Random 120 0.3", flush=True)

    # Small World Graphs
    run_experiment("Small_World_80", "small_world_80.csv", 100)
    print("Small 80", flush=True)
    run_experiment("Small_World_100", "small_world_100.csv", 100)
    print("Small 100", flush=True)
    run_experiment("Small_World_120", "small_world_120.csv", 100)
    print("Small 120", flush=True)

    # Preferential Attachment Graphs
    run_experiment("Preferential_Attachment_80", "pref_att_80.csv", 100)
    print("Preferential 80", flush=True)
    run_experiment("Preferential_Attachment_100", "pref_att_100.csv", 100)
    print("Preferential 100", flush=True)
    run_experiment("Preferential_Attachment_120", "pref_att_120.csv", 100)
