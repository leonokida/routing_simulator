...
if __name__ == "__main__":
    # Real Topologies
    run_experiment("ChinaNet", "results/chinanet.csv", 1)
    print("ChinaNet", flush=True)
    run_experiment("Geant", "results/geant.csv", 1)
    print("Geant", flush=True)
    run_experiment("Internet2", "results/internet2.csv", 1)
    print("Internet2", flush=True)
    run_experiment("RNP", "results/rnp.csv", 1)
    print("RNP", flush=True)

    # Random Graphs with varied connectivity
    run_experiment("Random_100_0.3", "results/random_100_03.csv", 1)
    print("Random 100 0.3", flush=True)
    run_experiment("Random_100_0.5", "results/random_100_05.csv", 1)
    print("Random 100 0.5", flush=True)
    run_experiment("Random_100_0.7", "results/random_100_07.csv", 1)
    print("Random 100 0.7", flush=True)
    run_experiment("Random_150_0.3", "results/random_150_03.csv", 1)
    print("Random 150 0.3", flush=True)
    run_experiment("Random_150_0.5", "results/random_150_05.csv", 1)
    print("Random 150 0.5", flush=True)
    run_experiment("Random_150_0.7", "results/random_150_07.csv", 1)
    print("Random 150 0.7", flush=True)
    run_experiment("Random_200_0.3", "results/random_200_03.csv", 1)
    print("Random 200 0.3", flush=True)
    run_experiment("Random_200_0.5", "results/random_200_05.csv", 1)
    print("Random 200 0.5", flush=True)
    run_experiment("Random_200_0.7", "results/random_200_07.csv", 1)
    print("Random 200 0.7", flush=True)

    # Small World Graphs
    run_experiment("Small_World_100", "results/small_world_100.csv", 1)
    print("Small 100", flush=True)
    run_experiment("Small_World_150", "results/small_world_150.csv", 1)
    print("Small 150", flush=True)
    run_experiment("Small_World_200", "results/small_world_200.csv", 1)
    print("Small 200", flush=True)

    # Preferential Attachment Graphs
    run_experiment("Preferential_Attachment_100", "results/pref_att_100.csv", 1)
    print("Preferential 100", flush=True)
    run_experiment("Preferential_Attachment_150", "results/pref_att_150.csv", 1)
    print("Preferential 150", flush=True)
    run_experiment("Preferential_Attachment_200", "results/pref_att_200.csv", 1)
